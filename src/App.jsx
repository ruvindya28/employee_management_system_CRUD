...
function App() {
  const [employeeData, setEmployeeData] = useState([
    { name: "Hansi Piyumika", date: "16/09/2024", reg: "FDSC2401" },
    { name: "Isuri Tharuka", date: "16/09/2024", reg: "FDSC2402" },
    { name: "Prabath Piyumika", date: "16/09/2024", reg: "FDSC2403" },
  ]);
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <div className="divide-y divide-gray-200">
          {employeeData.map((emp, index) => (
            <div key={index} className="grid grid-cols-4 items-center bg-gray-50 hover:bg-gray-100 p-4 transition">
